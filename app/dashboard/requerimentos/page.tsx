...
type Item = {
  id: string; referencia: string; data: string; texto: string
...
export default function RequerimentosPage() {
  ...
  async function excluir(id: string) {
    if (!confirm('Excluir este requerimento?')) return
    ...
    <div className="space-y-4 pb-6">
      ...
      <div className="relative">
        ...
        <input value={busca} onChange={e => setBusca(e.target.value)}
          placeholder="Buscar por referência, texto, origem..."
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          <p className="text-gray-400">Nenhum requerimento encontrado.</p>
          <Link href="/dashboard/requerimentos/novo"
          ...
          {filtrados.map(item => (
            <div key={item.id}
              ...
              <div className="flex-1 min-w-0">
                ...
                {/* Texto */}
                <p className="text-sm text-gray-700 mt-1 line-clamp-2">{item.texto}</p>
